let Raspored = (function(){
    //*****************************************************************
    //********** Sekcija za pomocne funckije na nivou modula **********
    //*****************************************************************
    ...
    //*******************************************************************
    //********** Sekcija za javne funckije koje su exportovane **********
    //*******************************************************************
    let iscrtajRasporedImplentacija = function iscrtajRaspored(okvir, dani, satPocetak, satKraj){
    ...
    let dodajAktivnostImplementacija = function dodajAktivnost(okvir, naziv, tip, vrijemePocetak, vrijemeKraj, dan){
    ...
    return {
        dodajAktivnost: dodajAktivnostImplementacija,
        iscrtajRaspored: iscrtajRasporedImplentacija
    }
})();
